...
import com.example.rcluster.RclusterTopic6App;
import com.example.rcluster.config.AsyncSyncConfiguration;
...
@SpringBootTest(classes = { RclusterTopic6App.class, AsyncSyncConfiguration.class })
